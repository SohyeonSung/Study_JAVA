...
public class StudentManager {
	...
	public static void main(String[] args) {
		...
		******************************** */
		...
		student1.getMath() + " " + student1.getAvg() + " " + student1.getTot());
		
		System.out.println(student2.getName() + " " + student2.getKor() + " " + student2.getEng() + " " + 
				student2.getMath() + " " + student2.getAvg() + " " + student2.getTot());
		

		System.out.println(student3.getName() + " " + student3.getKor() + " " + student3.getEng() + " " + 
				student3.getMath() + " " + student3.getAvg() + " " + student3.getTot());
